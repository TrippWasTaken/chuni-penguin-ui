...
export default function NavUserIcon() {
  ...
  if (session && session?.user) {
    ...
    return (
      <div className="dropdown dropdown-end p-0 m-0">
        ...
        <ul
          tabIndex={0}
          className="flex gap-4 z-[1] menu bg-base-300 dropdown-content shadow-2xl rounded-box text-base-content">
          <Link href={`/penguin/users/${id}`}>
  ...
  return (
    <div className="dropdown dropdown-end p-0 m-0 menu menu-sm">
      <div
        tabIndex={0}
        role="button"
        className="btn btn-round btn-ghost avatar h-20 p-0 m-0">
